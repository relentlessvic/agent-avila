...
Note: edits to safety-policy docs (`orchestrator/PROTECTED-FILES.md`, `orchestrator/APPROVAL-GATES.md`, `orchestrator/AUTOPILOT-RULES.md`, `orchestrator/BLUEPRINT.md`, `orchestrator/PHASE-MODES.md`, `orchestrator/NEXT-ACTION-SELECTOR.md`) require Codex docs-only review **and** explicit operator approval before commit, per `orchestrator/PROTECTED-FILES.md`. They are not auto-allowed.
...
- Approval-gate, phase-mode, or next-action-selector changes (Codex docs-only review of any change to this file, `PROTECTED-FILES.md`, `AUTOPILOT-RULES.md`, `BLUEPRINT.md`, `PHASE-MODES.md`, or `NEXT-ACTION-SELECTOR.md`)

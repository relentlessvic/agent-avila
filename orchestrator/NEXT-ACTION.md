...
The Migration 008 runbook `orchestrator/handoffs/N-2-MIGRATION-008-PRODUCTION-PLAN.md` IS part of the N-2y docs-only commit scope (Codex Q12 Path B §4(vii) ESM/CommonJS rule addition + §1.1 Attempt-5 back-fill + §14 N-2y entry + §1/§9/§11 phase-label updates) and remains the canonical runbook for N-3 at the latest committed HEAD per `git rev-parse HEAD`.

...
Note: edits to safety-policy docs (`orchestrator/PROTECTED-FILES.md`, `orchestrator/APPROVAL-GATES.md`, `orchestrator/AUTOPILOT-RULES.md`, `orchestrator/BLUEPRINT.md`, `orchestrator/PHASE-MODES.md`) require Codex docs-only review **and** explicit operator approval before commit, per `orchestrator/PROTECTED-FILES.md`. They are not auto-allowed.
...
- Approval-gate or phase-mode changes (Codex docs-only review of any change to this file, `PROTECTED-FILES.md`, `AUTOPILOT-RULES.md`, `BLUEPRINT.md`, or `PHASE-MODES.md`)

...
**Allowed actions.**
- Editing approved `orchestrator/*` files (`STATUS.md`, `CHECKLIST.md`, `NEXT-ACTION.md`, `BLUEPRINT.md`, `FIX-PLAN.md`, `APPROVAL-GATES.md`, `AUTOPILOT-RULES.md`, `PROTECTED-FILES.md`, `PHASE-MODES.md`, `prompts/**`).
...
- **Safety-policy docs** (`orchestrator/PROTECTED-FILES.md`, `orchestrator/APPROVAL-GATES.md`, `orchestrator/AUTOPILOT-RULES.md`, `orchestrator/BLUEPRINT.md`, `orchestrator/PHASE-MODES.md`): Codex docs-only review **required** before commit.

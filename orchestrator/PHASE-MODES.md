...
**Allowed actions.**
- Editing approved `orchestrator/*` files (`STATUS.md`, `CHECKLIST.md`, `NEXT-ACTION.md`, `BLUEPRINT.md`, `FIX-PLAN.md`, `APPROVAL-GATES.md`, `AUTOPILOT-RULES.md`, `PROTECTED-FILES.md`, `PHASE-MODES.md`, `NEXT-ACTION-SELECTOR.md`, `ROLE-HIERARCHY.md`, `AUTOMATION-PERMISSIONS.md`, `prompts/**`).
